...
const PARTY_LOGOS = {
    ...
    'राष्ट्रवादी काँग्रेस पार्टी': '/static/img/parties/RashwadiCongressParty.png',
    'एआईएम': '/static/img/parties/MIM.png',
    'अपक्ष': '/static/img/parties/independent.svg'
};
...
async function loadCandidates() {
    try {
        ...
        if (data.success) {
            ...
            candidates = Array.from(unique.values()).sort((a,b) => (a.display_order||0) - (b.display_order||0));
            renderCandidates();
        } else {
...
const STRINGS = {
    hi: {
        page_title: 'प्रभाग क्र. 8 – ब: मैं जनता के',
